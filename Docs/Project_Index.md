...
- [Subsystems/CarSA.md](Subsystems/CarSA.md) — car-based spatial awareness (CarIdx truth, RealGap checkpoints, slot semantics + debug export).
...
| CarSA | Car-based spatial awareness and RealGap checkpoints with TrackSurface semantics, half-lap filtering, and debug export | [Subsystems/CarSA.md](Subsystems/CarSA.md) |
