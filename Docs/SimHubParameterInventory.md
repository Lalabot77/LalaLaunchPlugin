...
| Pit.EntryLineDebriefText | string | Plain-English debrief message for the pit entry line outcome. | Latched on pit entry line. | `PitEngine.UpdatePitEntryAssist` + `AttachCore`【F:PitEngine.cs†L447-L497】【F:LalaLaunch.cs†L3045-L3048】 |
